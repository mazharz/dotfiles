...
keymap("n", "<A-C-Left>", "<C-w>16<", opts)
keymap("i", "<A-C-Left>", "<C-w>16<", opts)
keymap("n", "<A-C-Right>", "<C-w>16>", opts)
keymap("i", "<A-C-Right>", "<C-w>16>", opts)
keymap("n", "<A-C-Up>", "<C-w>16-", opts)
keymap("i", "<A-C-Up>", "<C-w>16-", opts)
keymap("n", "<A-C-Down>", "<C-w>16+", opts)
keymap("i", "<A-C-Down>", "<C-w>16+", opts)
...
-- copy stuff
-------------------------------------------------------------------------------
keymap("n", "<leader>Y%", ":!echo -n % | wl-copy<CR>")
