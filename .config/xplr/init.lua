...
-- Type: [Style](https://xplr.dev/en/style)
xplr.config.general.focus_ui.style = { add_modifiers = { "Bold", "Underlined" } }
...
--
-- Type: [Style](https://xplr.dev/en/style)
xplr.config.general.panel_ui.default.border_style = { fg = colors.dark2 }
...
-- ```
xplr.config.node_types.symlink.meta.icon = "l"
...
-- The default layout without help menu & selected options
...
xplr.config.modes.builtin.default = {
  ...
  key_bindings = {
    on_key = {
      -- open highlighted item with nvim
      ["alt-e"] = {
        help = "open file with nvim",
        messages = {
          {
            BashExec = [===[
      ...
      -- open highlighted item with umpv
      ["alt-v"] = {
        help = "open file with umpv",
        messages = {
          {
            BashExec = [===[
              umpv "${XPLR_FOCUS_PATH:?}" & disown
            ]===]
          }
        }
      },
